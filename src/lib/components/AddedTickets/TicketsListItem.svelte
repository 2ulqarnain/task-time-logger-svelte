...
<li class="group relative -mb-20 transition-[margin] hover:-mb-3 last:hover:-mb-20">
	...
	<div
		class="row-span-2 grid grid-cols-1 grid-rows-[auto_1fr_auto] items-center gap-2 overflow-hidden rounded-2xl border border-zinc-400 bg-gray-300 shadow-[0_-10px_20px_#0001]"
	>
